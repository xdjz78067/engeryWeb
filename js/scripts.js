...
(function() {
   ...
   function searchform_reposition() {
    ...
    function MainLeftMenu() {
        ...
        var urlStr2 = urlStr.substring(urlStr.lastIndexOf("/") + 1, urlStr.lastIndexOf("."));
        if(urlStr2=="/"){urlStr2="index";}
        var $menuLi=$("#li" + urlStr2);
        if ($menuLi.length > 0) {
            $menuLi.addClass("active");
            if($menuLi.parents("li").hasClass("menu-list")){
                $menuLi.parents("li").addClass("nav-active");
            }
